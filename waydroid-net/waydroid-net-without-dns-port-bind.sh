...
start() {
   ...
   #modified, disable dns port bind and use host dns servers (option 6 is nameservers aka DNS)
   dnsmasq -p 0 --dhcp-option="6,1.1.1.1,8.8.8.8" $LXC_DHCP_CONFILE_ARG $LXC_DOMAIN_ARG $LXC_DHCP_PING_ARG -u ${DNSMASQ_USER} \
